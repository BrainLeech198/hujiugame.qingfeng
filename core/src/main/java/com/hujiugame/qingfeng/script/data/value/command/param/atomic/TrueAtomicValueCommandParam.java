...
public class TrueAtomicValueCommandParam implements ValueCommandParam
{
    ...
    public TrueAtomicValueCommandParam ()
    {
        valid = true;
        buildJson();
    }

    public TrueAtomicValueCommandParam (JsonEntity json)
    {
        valid = true;
    ...
    public String toString() {
        return "TrueAtomicValueCommandParam{" +
            "valid=" + valid +
            ", json=" + json +
            '}';
    }
