...
public class NotLogicValueCommandParam implements ValueCommandParam
{
    ...
    public NotLogicValueCommandParam ()
    {
        valid = true;
        buildJson();
    }

    public NotLogicValueCommandParam (JsonEntity json)
    {
        valid = true;
    ...
    public String toString() {
        return "NotLogicValueCommandParam{" +
            "valid=" + valid +
            ", json=" + json +
            '}';
    }
