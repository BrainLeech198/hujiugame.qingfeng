...
- **第三方素材版权登记** — `assets/THIRDPARTY_LICENSES.md` 登记 4 个非自创文件关联图标来源（document 5_122642、language-setting 159167、color-lens 90605，均 icon-icons.com 免费商用授权；qfgl/qfgt 为 document 配色互换变体），`qfg.ico` 列入原创素材清单
